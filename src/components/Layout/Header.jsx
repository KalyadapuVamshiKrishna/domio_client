...
export default function Header() {
  ...
  const [locationInput, setLocationInput] = useState(""); // ✅ Fixed variable naming
  ...
  const { pathname } = useLocation(); // ✅ Now using useLocation
  ...
  function handleSearch() {
    if (!locationInput) return; // ✅ Fixed wrong variable name (was location)
